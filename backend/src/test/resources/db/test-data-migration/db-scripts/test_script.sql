...
VALUES ('John', 'Doe', 'JD', 'EMPLOYED', '2020-01-01', '1990-01-01', 1);
...
VALUES ('Experience_type', 1, 0, 0);

INSERT INTO experience(member_id, name, employer, percent, experience_type_id, start_date, end_date)
VALUES (1000, 'Experience', 'Whoever', 100, 1000, '2021-08-01', '2022-08-01'),
        (1000, 'Experience', 'Whoever', 60, 1000, '2022-08-01', '2023-02-01'),
...
VALUES (1000, 'Lehre (real)', 'BIT', true, 1000, '2020-02-03', null),
        (1000, 'BM (real)', 'Gibb', true, 1001, '2020-02-03', null);
...
VALUES (1000, 1000, 1, 'STRONGLY'),
       (1000, 1001, 1, 'STRONGLY');
