...
class ExperienceMapperTest {
    ...
    void shouldThrowExceptionWhenMemberWithIdDoesNotExist() {
        when(memberBusinessService.getById(5L)).thenThrow(new PCTSException(HttpStatus.NOT_FOUND, ErrorKey.NOT_FOUND, Map.of("entity", "member", "field", "id", "is", "5")));
        ...
        assertEquals(Map.of("entity", "member", "field", "id", "is", "5"), exception.getErrors().get(0).getValues());
    ...
    void shouldThrowExceptionWhenExperienceTypeWithIdDoesNotExist() {
        when(experienceTypeBusinessService.getById(5L)).thenThrow(new PCTSException(HttpStatus.NOT_FOUND, ErrorKey.NOT_FOUND, Map.of("entity", "ExperienceType", "field", "id", "is", "5")));
        ...
        assertEquals(Map.of("entity", "ExperienceType", "field", "id", "is", "5"), exception.getErrors().get(0).getValues());
        assertEquals(ErrorKey.NOT_FOUND, exception.getErrors().get(0).getKey());
    }
}
