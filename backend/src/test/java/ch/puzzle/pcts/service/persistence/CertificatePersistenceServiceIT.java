...
class CertificatePersistenceServiceIT
    ...
    List<Certificate> getAll() {
        ...
        Certificate certificate5 = Certificate.Builder
                ...
                .withCertificateType(createCertificateType(5L,
        ...
        return List.of(certificate1, certificate2, certificate3, certificate4, certificate5);
    }
    ...
    private CertificateType createCertificateType(Long id, String name, BigDecimal points, String comment,
                                                  Set<Tag> tags, CertificateKind certificateKind) {
        ...
        certificateType.setCertificateKind(certificateKind);
