...
INSERT INTO member (first_name, last_name, email, ldap_name, abbreviation, employment_state, date_of_hire, birth_date, organisation_unit)
VALUES
    ('Lena', 'Müller', 'muller@puzzle.ch', 'lmueller', 'LM', 'MEMBER', '2021-07-15', '1999-08-10', 1),
    ('Jonas', 'Schmidt', 'schmidt@puzzle.ch', 'jschmidt', 'JS', 'MEMBER', '2020-06-01', '1998-03-03', 2),
