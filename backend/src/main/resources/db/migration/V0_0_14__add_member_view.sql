...
SELECT
    ...
    m.abbreviation         AS member_abbreviation,
    m.employment_state     AS member_employment_state,
    m.date_of_hire         AS member_date_of_hire,
    ...
    l.comment              AS leadership_comment,

    lt.name                AS leadership_type_name,
    lt.comment             AS leadership_type_comment,
    lt.certificate_kind    AS leadership_type_kind,
...
FROM member m
         ...
         LEFT JOIN certificate l ON l.member_id = m.id
         LEFT JOIN certificate_type lt ON lt.id = l.certificate_type_id
