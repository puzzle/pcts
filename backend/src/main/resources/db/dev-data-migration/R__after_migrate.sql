...
VALUES
    ('CompTIA A+', 5.0, NULL, 'Entry-level IT certification covering hardware, software, and troubleshooting', 'CERTIFICATE', 5, 120, 'https://example.com/', 'MULTIPLE_CHOICE', 'Puzzle ITC', 0, null),
    ('Cisco CCNA', 7.5, '2023-06-20 14:21:27.063055', 'Cisco Certified Network Associate – networking fundamentals and routing/switching', 'CERTIFICATE', 5, 120, 'https://example.com/', 'MULTIPLE_CHOICE', 'Puzzle ITC', 0, null),
    ('Microsoft 365 Administrator Associate', 6.0, NULL, 'Cloud and productivity administration in Microsoft 365 environments', 'CERTIFICATE', 5, 120, 'https://example.com/', 'MULTIPLE_CHOICE', 'Puzzle ITC', 0, null),
    ('AWS Certified Solutions Architect – Associate', 8.0, NULL, 'Amazon Web Services cloud design and deployment certification', 'CERTIFICATE', 5, 120, 'https://example.com/', 'MULTIPLE_CHOICE', 'Puzzle ITC', 0, null),
    ('ITIL 4 Foundation', 4.0, NULL, 'Certification in IT service management best practices', 'CERTIFICATE', 5, 120, 'https://example.com/', 'MULTIPLE_CHOICE', 'Puzzle ITC', 0, null),
    ('Google IT Support Professional', 5.5, NULL, 'Foundational IT skills including networking, OS, and security basics', 'CERTIFICATE', 5, 120, 'https://example.com/', 'MULTIPLE_CHOICE', 'Puzzle ITC', 0, null),
    ('Red Hat Certified System Administrator (RHCSA)', 7.0, NULL, 'Linux administration and system management certification', 'CERTIFICATE', 5, 120, 'https://example.com/', 'MULTIPLE_CHOICE', 'Puzzle ITC', 0, null),
    ('Certified Information Systems Security Professional (CISSP)', 9.0, NULL, 'Advanced cybersecurity certification for security leadership roles', 'CERTIFICATE', 5, 120, 'https://example.com/', 'MULTIPLE_CHOICE', 'Puzzle ITC', 0, null),
    ('Project Management Professional (PMP)', 8.5, NULL, 'Globally recognized project management certification', 'CERTIFICATE', 5, 120, 'https://example.com/', 'MULTIPLE_CHOICE', 'Puzzle ITC', 0, null),
    ('Microsoft Certified: Azure Administrator Associate', 7.5, NULL, 'Managing Azure cloud services and resources', 'CERTIFICATE', 5, 120, 'https://example.com/', 'MULTIPLE_CHOICE', 'Puzzle ITC', 0, null),

    --     Below are all the LeadershipExperiences
    ('Soldier', 7.5, NULL, '', 'MILITARY_FUNCTION', 5, 120, 'https://example.com/', 'MULTIPLE_CHOICE', 'Puzzle ITC', 0, null),
    ('Ski Camp Manager', 5, NULL, '', 'YOUTH_AND_SPORT', 5, 120, 'https://example.com/', 'MULTIPLE_CHOICE', 'Puzzle ITC', 0, null),
    ('Leader Essentials', 2, NULL, '', 'LEADERSHIP_TRAINING', 5, 120, 'https://example.com/', 'MULTIPLE_CHOICE', 'Puzzle ITC', 0, null);
...
VALUES
    ...
    ( 'Mara', 'Becker', 'MB', 'EX_MEMBER', '2023-01-09', '2001-08-05', null, 5, '2025-01-28', 0),
    ( 'Felix', 'Hofmann', 'FH', 'EX_MEMBER', '2021-09-17', '2000-02-29', 1, 6, '2025-01-28', 0);
