...
VALUES
    ('CompTIA A+', 5.0, NULL, 'Entry-level IT certification covering hardware, software, and troubleshooting', 5, 120, 'https://example.com/', 'MULTIPLE_CHOICE', 'Puzzle ITC', 0, null),
    ('Cisco CCNA', 7.5, '2023-06-20 14:21:27.063055', 'Cisco Certified Network Associate – networking fundamentals and routing/switching',  5, 120, 'https://example.com/', 'MULTIPLE_CHOICE', 'Puzzle ITC', 0, null),
    ('Microsoft 365 Administrator Associate', 6.0, NULL, 'Cloud and productivity administration in Microsoft 365 environments', 5, 120, 'https://example.com/', 'MULTIPLE_CHOICE', 'Puzzle ITC', 0, null),
    ('AWS Certified Solutions Architect – Associate', 8.0, NULL, 'Amazon Web Services cloud design and deployment certification', 5, 120, 'https://example.com/', 'MULTIPLE_CHOICE', 'Puzzle ITC', 0, null),
    ('ITIL 4 Foundation', 4.0, NULL, 'Certification in IT service management best practices', 5, 120, 'https://example.com/', 'MULTIPLE_CHOICE', 'Puzzle ITC', 0, null),
    ('Google IT Support Professional', 5.5, NULL, 'Foundational IT skills including networking, OS, and security basics', 5, 120, 'https://example.com/', 'MULTIPLE_CHOICE', 'Puzzle ITC', 0, null),
    ('Red Hat Certified System Administrator (RHCSA)', 7.0, NULL, 'Linux administration and system management certification', 5, 120, 'https://example.com/', 'MULTIPLE_CHOICE', 'Puzzle ITC', 0, null),
    ('Certified Information Systems Security Professional (CISSP)', 9.0, NULL, 'Advanced cybersecurity certification for security leadership roles', 5, 120, 'https://example.com/', 'MULTIPLE_CHOICE', 'Puzzle ITC', 0, null),
...
VALUES
    ('Lena', 'Müller',   'lmueller', 'LM', 'MEMBER', '2021-07-15', '1999-08-10', 1, null, null, null),
    ('Jonas', 'Schmidt',    'jschmidt', 'JS', 'MEMBER', '2020-06-01', '1998-03-03', 2, 2, '2025-01-28', 0),
    ( 'Sophie', 'Keller', 'skeller', 'SK', 'APPLICANT', '2019-11-22', '1999-02-28', 3, 3, '2025-01-28', 0),
    ( 'Tobias', 'Weber', 'tweber', 'TW', 'APPLICANT', '2022-02-14', '2000-07-06', 4, 4, '2025-01-28', 0),
    ( 'Mara', 'Becker', 'mbecker', 'MB', 'EX_MEMBER', '2023-01-09', '2001-08-05', null, 5, '2025-01-28', 0),
    ( 'Felix', 'Hofmann', 'fhofmann', 'FH', 'EX_MEMBER', '2021-09-17', '2000-02-29', 1, 6, '2025-01-28', 0),
    ( 'Jaya', 'Norris', 'gl', 'JN', 'MEMBER', '2021-09-17', '2000-02-29', 1, null, null, null),
    ( 'Abraham', 'Woodard',  'member', 'AW', 'MEMBER', '2021-09-17', '2004-02-29', 3, null, null, null),
    ('Ashleigh', 'Russell', 'arussell', 'AR', 'APPLICANT', null, '1998-02-19', null, null, null, null);
