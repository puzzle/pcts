...
public record LeadershipExperienceDto(
        ...
        @Schema(description = "The member associated with this leadership experience.", requiredMode = Schema.RequiredMode.REQUIRED, nullable = false) MemberDto member,

        @Schema(description = "The type of leadership experience awarded to the member.", requiredMode = Schema.RequiredMode.REQUIRED, nullable = false) LeadershipExperienceTypeDto experience,
