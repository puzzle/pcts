...
public record MemberDto(
        ...
        @Schema(description = "The last name of the member.", example = "Miller", requiredMode = Schema.RequiredMode.REQUIRED, nullable = false, minLength = 1) String lastName,
        ...
        @Schema(description = "The abbreviation of the member.", example = "SM", requiredMode = Schema.RequiredMode.REQUIRED, nullable = false, minLength = 1, maxLength = 3) String abbreviation,
        ...
        @Schema(description = "The Organisation unit of the member.", example = "\"{\"id\": 1, \"name\": \"/bbt\"}\"", requiredMode = Schema.RequiredMode.REQUIRED, nullable = false, minLength = 1) OrganisationUnitDto organisationUnit) {
}