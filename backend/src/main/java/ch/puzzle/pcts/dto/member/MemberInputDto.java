...
public record MemberInputDto(
        ...
        @Schema(description = "The Organisation unit id of the member.", example = "1", requiredMode = Schema.RequiredMode.REQUIRED, nullable = false, minLength = 1) Long organisationUnitId) {
}