...
public record CertificateTypeDto(
        ...
        @Schema(description = "The time the course takes and the learning time combined in days", example = "5", requiredMode = Schema.RequiredMode.REQUIRED) Double effort,
        @Schema(description = "The duration of the exam in minutes, should be null when no exam is conducted", example = "120", requiredMode = Schema.RequiredMode.NOT_REQUIRED, nullable = true) Integer examDuration,
        @Schema(description = "An optional URL containing more information", example = "https://example.com", requiredMode = Schema.RequiredMode.NOT_REQUIRED, nullable = true) String link,
        @Schema(description = "A predefined list of exam types", example = "THEORETICAL", requiredMode = Schema.RequiredMode.REQUIRED) ExamType examType,
