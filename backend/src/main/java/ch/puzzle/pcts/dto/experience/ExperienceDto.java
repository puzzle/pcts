...
public record ExperienceDto(
        ...
        @Schema(description = "The member associated with this experience.", requiredMode = Schema.RequiredMode.REQUIRED, nullable = false) MemberDto member,
        ...
        @Schema(description = "The type or category of the experience.", requiredMode = Schema.RequiredMode.REQUIRED, nullable = false) ExperienceTypeDto experienceType,
