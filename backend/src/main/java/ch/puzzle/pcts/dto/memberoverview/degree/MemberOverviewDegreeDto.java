...
public record MemberOverviewDegreeDto(
        ...
        @Schema(description = "The type of the degree", exampleClasses = MemberOverviewDegreeTypeDto.class, requiredMode = Schema.RequiredMode.REQUIRED) MemberOverviewDegreeTypeDto type,
