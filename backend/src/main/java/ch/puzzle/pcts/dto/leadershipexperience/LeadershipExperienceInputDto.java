...
public record LeadershipExperienceInputDto(
        ...
        @Schema(description = "The leadership experience type id awarded to the member.", example = "1", requiredMode = Schema.RequiredMode.REQUIRED, nullable = false) Long leadershipExperienceTypeId,
