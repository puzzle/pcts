...
public record LeadershipExperienceInputDto(
        ...
        @Schema(description = "The leadership experience type id awarded to the member.", example = "11", requiredMode = Schema.RequiredMode.REQUIRED, nullable = false) Long leadershipExperienceTypeId,
