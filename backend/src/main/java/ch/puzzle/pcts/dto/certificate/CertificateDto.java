...
public record CertificateDto(
        ...
        @Schema(description = "Tags that provide additional information about the certificate", example = "[\"Important Tag\", \"GitLab\", \"Exam\"]", requiredMode = Schema.RequiredMode.NOT_REQUIRED, nullable = true, minLength = 1) List<String> tags) {
}
