...
public record CertificateDto(
        ...
        @Schema(description = "The member associated with this certificate.", requiredMode = Schema.RequiredMode.REQUIRED, nullable = false) MemberDto member,

        @Schema(description = "The type of certificate awarded to the member.", requiredMode = Schema.RequiredMode.REQUIRED, nullable = false) CertificateTypeDto certificate,
