...
public record CertificateDto(
        @Schema(description = "The unique identifier of certificate.", example = "1", requiredMode = Schema.RequiredMode.REQUIRED, accessMode = Schema.AccessMode.READ_ONLY, nullable = true) Long id,
