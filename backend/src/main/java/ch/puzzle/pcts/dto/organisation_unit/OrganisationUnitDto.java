...
public record OrganisationUnitDto(
        ...
        @Schema(description = "The name of the organisation unit.", example = "/mobility", requiredMode = Schema.RequiredMode.REQUIRED, nullable = false, minLength = 1) String name) {
}
