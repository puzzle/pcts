...
//
//    // Hinweis: @MockitoBean ersetzt seit Spring Boot 3.4 das alte @MockBean aus Spring Boot Test
//    @MockitoBean
...
//
//        @Test
//        @DisplayName("Sollte Datei extrahieren, Zertifikate anlegen und HTTP 201 Created mit JSON-Body zurückgeben")
//        void certificates_whenValidFileUploaded_extractsCreatesAndReturns201() throws Exception {
//            // Given
...
//
//            // Sicherstellen, dass extract(...) UND create(...) im Hintergrund ausgeführt wurden
//            verify(extractorService, times(1)).extract(eq(file), eq(certificateExtractionPipeline));
//            verify(certificateExtractionPipeline, times(1)).create(eq(extractedDtos));
//        }
//
//        @Test
//        @DisplayName("Sollte Fehler weiterwerfen und create nicht aufrufen, wenn die Extraktion fehlschlägt")
//        void certificates_whenExtractionFails_throwsExceptionAndDoesNotCreate() throws Exception {
//            // Given
//            MockMultipartFile file = new MockMultipartFile(
//                    "file",
//                    "corrupted.ods",
...
//
//        @Test
//        @DisplayName("Sollte HTTP 400 Bad Request zurückgeben, wenn der Request kein 'file'-Part enthält")
