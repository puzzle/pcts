...
// when(pipeline.mapToDto("test.ods",
// AI_RESULT)).thenReturn(List.of(EXPECTED_DTO));
//
...
//
// @Test
// @DisplayName("should throw migration exception when jakarta validation
// fails")
...
// when(odsParserService.parseToPromptText(file, new
// ArrayList<>())).thenReturn(MARKDOWN);
...
// when(aiService.extract(MARKDOWN, "System Prompt",
// DummyResult.class)).thenReturn(AI_RESULT);
// }
//
