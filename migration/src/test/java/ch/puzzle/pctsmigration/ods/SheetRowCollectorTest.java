...
class SheetRowCollectorTest {
    ...
    void withoutMarker_startsImmediatelyAndNeverStops() {
        ...
        assertThat(collector.getCollectedRows()).containsExactly(List.of("Row 1"), List.of("Row 2"));
    }
    ...
    void resetsEmptyRowCount_onValidRow() {
        ...
        assertThat(collector.getCollectedRows()).containsExactly(List.of("START"), List.of("Valid Data"));
    }
}